...
describe('MainMenu', () => {
  ...
  it('should render the Menu container', async () => {
    setup();
  ...
  it('should open the nutritionist submenu by default', async () => {
    setup();
  ...
  it('should select the nutritionist dashboard item by default', async () => {
    setup();
  ...
  it('should render correct links for items', async () => {
    setup();
  ...
  it('should render icons for top-level items and nested nutritionist items', async () => {
    setup();
